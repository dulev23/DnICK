"""
URL configuration for FlightManagementApplication project.
...
from FlightApp.FlightApp import views as FlightAppViews
...
urlpatterns = [
                  ...
                  path('edit-flight/<flight_id>', FlightAppViews.edit_flight, name='edit-flight'),
